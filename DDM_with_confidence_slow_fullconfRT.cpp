// in r: install rcpp library and ZigguratRCPP library, then source this script and the function becomes available (source('DDM_with_confidence_slow_fullconfRT'))
#include <Rcpp.h>
